...
const METHOD_COLORS: Record<string, { bg: string; hover: string; text: string; badge: string }> = {
  ...
  POST: { bg: "bg-violet-50", hover: "hover:bg-violet-100", text: "text-violet-700", badge: "bg-violet-600 text-white" },
  PUT: { bg: "bg-violet-50", hover: "hover:bg-violet-100", text: "text-violet-700", badge: "bg-violet-500 text-slate-900" },
  PATCH: { bg: "bg-violet-50", hover: "hover:bg-violet-100", text: "text-violet-700", badge: "bg-violet-500 text-slate-900" },
  DELETE: { bg: "bg-rose-50", hover: "hover:bg-rose-100", text: "text-rose-700", badge: "bg-rose-600 text-white" },
  OPTIONS: { bg: "bg-violet-50", hover: "hover:bg-violet-100", text: "text-violet-700", badge: "bg-violet-500 text-white" },
...
function getStatusColor(status: number): string {
  ...
  if (status >= 300 && status < 400) return "text-violet-600 bg-violet-50";
            ...
            <div className="p-5">
              <div className="relative mb-4">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-slate-200 bg-white py-2.5 pl-9 pr-4 text-sm outline-none transition-all focus:border-violet-400 focus:ring-2 focus:ring-violet-100"
                />
              </div>
                  ...
                  {filteredEndpoints.map((endpoint) => (
                    ...
                    >
                      <div className="flex items-start justify-between gap-2">
                        <div className="flex-1">
                          <p className="font-mono text-sm font-semibold text-slate-900 group-hover:text-violet-600">
                            {endpoint.path}
                          </p>
                        ...
                        {docPath === endpoint.path && (
                          <div className="h-2 w-2 rounded-full bg-violet-600 shadow-sm" />
                        )}
                      </div>
            ...
            <div className="p-5">
              ...
              <div className="mb-4 grid gap-3 sm:grid-cols-[140px,1fr]">
                <select
                  ...
                  className="rounded-xl border border-slate-200 bg-white px-3 py-2.5 text-sm font-medium outline-none transition-all focus:border-violet-400 focus:ring-2 focus:ring-violet-100"
                >
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-slate-200 px-3 py-2.5 font-mono text-sm outline-none transition-all focus:border-violet-400 focus:ring-2 focus:ring-violet-100"
                />
              </div>
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-slate-200 px-3 py-2.5 text-sm outline-none transition-all focus:border-violet-400 focus:ring-2 focus:ring-violet-100"
                />
              </div>
              ...
              <div className="mb-4">
                ...
                {showHeaders && (
                  <textarea
                    ...
                    rows={4}
                    className="w-full rounded-xl border border-slate-200 px-3 py-2.5 font-mono text-xs outline-none transition-all focus:border-violet-400 focus:ring-2 focus:ring-violet-100"
                  />
                )}
              </div>
              ...
              <div className="flex flex-wrap gap-3">
                <button
                  ...
                  className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-violet-600 to-violet-600 px-5 py-2.5 text-sm font-semibold text-white transition-all duration-200 hover:scale-105 hover:shadow-lg"
                >
